...
const AppContent: React.FC = () => {
    ...
    return (
        <div className="h-screen flex flex-col bg-gradient-to-br from-rose-50 via-pink-50 to-amber-50 relative">
            <SettingsModal />
            <ExpiryCountdown />

            {/* Header */}
            <header className="bg-white/80 backdrop-blur-md border-b border-rose-100 flex-none z-10 shadow-sm">
                <div className="w-full px-6 py-3">
                    <div className="flex flex-col md:flex-row items-center justify-between gap-4 md:gap-0">
                        <div className="flex items-center gap-3">
                            <div className="bg-gradient-to-r from-rose-500 to-pink-500 p-2 rounded-lg text-white shadow-rose-200 shadow-lg">
                                <Heart size={24} fill="currentColor" />
                            </div>
                            <div>
                                <h1 className="text-2xl font-bold text-rose-800 tracking-tight uppercase">LOVELY TEACHER</h1>
                    ...
                    ${mode === AppMode.SINGLE ? 'bg-white text-rose-700 shadow-sm ring-1 ring-black/5' : 'text-slate-500 hover:text-rose-600'}`}
                                >
                                    <User size={18} />
                                ...
                                <button
                                    ...
                                    className={`flex items-center gap-2 px-3 md:px-4 py-2 rounded-lg text-sm font-semibold transition-all duration-200 whitespace-nowrap
                    ${mode === AppMode.BATCH ? 'bg-white text-rose-700 shadow-sm ring-1 ring-black/5' : 'text-slate-500 hover:text-rose-600'}`}
                                >
                                    <Users size={18} />
            ...
            <main className="flex-1 overflow-hidden">
                {mode === AppMode.STUDENT_MANAGEMENT ? (
                    ...
                    <div className="h-full w-full grid grid-cols-12 gap-0">
                        ...
                        {/* Left Column */}
                        <div className="col-span-12 lg:col-span-6 h-full overflow-y-auto border-r border-rose-100 bg-white/50 p-6 scrollbar-thin scrollbar-thumb-rose-200">
                            <div className="max-w-xl mx-auto space-y-6">
                                ...
                                <div className="mt-8 pt-6 border-t border-rose-200/60">
                                    <div className="bg-gradient-to-br from-white to-rose-50 rounded-xl p-5 border border-rose-100 shadow-sm text-center relative overflow-hidden group hover:shadow-md transition-all">
                                        ...
                                        <p className="text-sm text-slate-700 font-medium mb-4">
                                            Mọi thông tin chi tiết liên hệ cô <span className="font-bold text-rose-600 text-base">Ms Ly AI</span>
                                        </p>
                                        <div className="flex flex-col sm:flex-row items-center justify-center gap-3">
                                            ...
                                            <div className="flex items-center gap-2 px-4 py-2 bg-white border border-slate-200 text-slate-700 rounded-lg text-xs font-bold cursor-default w-full sm:w-auto justify-center shadow-sm">
                                                <Phone size={16} className="text-green-600" /> Zalo: 0962859488
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                {(currentEmail || loading) ? (
                                    <div className="h-full flex flex-col space-y-4">
                                        {mode === AppMode.BATCH && currentEmail && (
                                            <div className="flex-none flex items-center gap-2 text-sm text-rose-700 bg-rose-100/50 px-4 py-2 rounded-lg border border-rose-200/50 backdrop-blur-sm w-fit">
                                                <Users size={16} />
                                    ...
                                    <div className="h-full flex flex-col items-center justify-center text-center p-8">
                                        {mode === AppMode.BATCH ? (
                                            <div className="bg-white/80 backdrop-blur-sm rounded-2xl p-8 border border-white shadow-xl shadow-rose-100/50 max-w-lg text-left">
                                                <h3 className="font-bold text-rose-800 text-lg mb-4 flex items-center gap-2">
                                                    <FileSpreadsheetIcon /> 🌸 Hướng dẫn tải lên
                                                </h3>
                                                <p className="text-rose-700 mb-6 leading-relaxed text-sm">
                                            ...
                                            <div className="border-2 border-dashed border-rose-200/50 rounded-2xl bg-white/40 p-12 max-w-md">
                                                <div className={`w-20 h-20 bg-white rounded-full flex items-center justify-center mb-6 shadow-sm mx-auto ${mode === AppMode.ZALO ? 'text-blue-400' : 'text-rose-300'}`}>
                                                    {mode === AppMode.ZALO ? <MessageCircle size={40} /> : <GraduationCap size={40} />}
                                                </div>
                                                <h3 className="text-rose-800 font-semibold text-xl mb-2">🌸 Không gian làm việc</h3>
