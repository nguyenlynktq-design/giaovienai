            ...
            if (file.name.endsWith('.xlsx') || file.name.endsWith('.xls')) {
                ...
                reader.onload = async (event) => {
                    try {
                        ...
                        if (!wsname) {
                            throw new Error("File Excel không có sheet nào. Vui lòng kiểm tra lại file.");
                        }
    ...
    if (students.length === 0 && !isAnalyzing) {
        return (
            <div className="h-full flex flex-col items-center justify-center p-8 text-center bg-slate-50/50">
                <div className="bg-white p-10 rounded-3xl shadow-xl border border-dashed border-rose-200 max-w-2xl w-full">
